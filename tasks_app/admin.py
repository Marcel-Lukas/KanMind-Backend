"""Admin configuration for ``Task`` and ``TaskComment`` models."""
...
class TaskAdmin(admin.ModelAdmin):
    """Admin view for tasks with optimised related lookups."""
    ...
    search_fields = (
        'title', 'description', 'board__title',
...
class TaskCommentAdmin(admin.ModelAdmin):
    """Admin view for task comments with a truncated content preview."""

    list_display = ('id', 'task', 'author', 'created_at', 'short_content')
    search_fields = (
        'content', 'author__username', 'author__email', 'task__title',
    )
    ...
    def short_content(self, obj):
        """Return a shortened preview of the comment content."""
